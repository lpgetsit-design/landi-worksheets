...
const SpacePage = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-3.5rem)]">
      {/* Sidebar: folder tree */}
      <aside className="w-64 border-r border-border bg-card/40 overflow-y-auto p-2">
        <div className="px-1.5 mb-2 text-[10px] uppercase tracking-wider text-muted-foreground">
          Folders
        </div>
        {foldersLoading ? (
