...
export default function CrmBadgeInline({ entityType, entityId, label }: CrmBadgeInlineProps) {
  ...
  return (
    <span className="inline-flex items-center gap-1 rounded border border-border bg-muted px-1.5 py-0.5 text-xs font-medium text-foreground align-baseline mx-0.5 select-none">
